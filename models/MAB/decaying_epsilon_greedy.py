...
# ***************************************************
# * File        : decaying_epsilon_greedy.py
# * Author      : Zhefeng Wang
...
class DecayingEpsilonGreedy(Solver):
    """
    epsilon 值随时间衰减的 epsilon-贪婪算法(epsilon-greedy), 继承 Solver类
    """
...
def main():
    ...
    decaying_epsilon_greedy_solver = DecayingEpsilonGreedy(bandit=bandit_10_arm)
    decaying_epsilon_greedy_solver.run(num_steps=5000)
    logger.info(f"Decaying epsilon-贪婪算法的累计懊悔为：{decaying_epsilon_greedy_solver.regret}")
